...
public class Main {
    public static void main(String[] args) {
        ...
        Account second = new Account(2,20000);
        Account third = new Account(3,30000);
        Account fourth = new Account(4,40000);
        Account fifth = new Account(5,50000);
        Account sixth = new Account(6,60000);
        Account seventh = new Account(7,70000);
        Account eighth = new Account(8,80000);
        Account ninth = new Account(9,90000);
        Account tenth = new Account(10,100000);
        ...
        newAccount acc = new newAccount(1111, 1100, "Мария");
